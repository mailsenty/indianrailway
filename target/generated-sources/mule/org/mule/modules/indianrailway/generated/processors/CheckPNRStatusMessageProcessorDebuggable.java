...
public class CheckPNRStatusMessageProcessorDebuggable
    extends CheckPNRStatusMessageProcessor
    implements DebugInfoProvider
{


    public CheckPNRStatusMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("PNR", "P n r", (java.lang.String.class), PNR, muleEvent));
