...
public class FindStationMessageProcessorDebuggable
    extends FindStationMessageProcessor
    implements DebugInfoProvider
{


    public FindStationMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
